...
var scenarios = [
    ...
    },
    {
        ...
        "scenarioContent":"It's the day before Dr. O'Neal's full-timers' ****** class. Two hours ago she had received an email from the school's administrator saying that the class's room is going to be changed, starting tomorrow. The administrator advised Dr. O'Neal in her email, to check the class's new location in two hours time using the grangeMobile app. For that reason, Dr. O'Neal now opens the app and presses the Search My Classes button. Inside the search field, she types the class's module name, and hits the Search button. She receives a list containing all of that module's classes which she teaches. She browses the list, and taps on the full-timers' class. She now sees the class's new location, and sends a message to her students drawing their attention to the class's new location (diagram does not highlight data and behaviour relating to the sending of the message, as it has been covered in a previous scenario)."
    }
];